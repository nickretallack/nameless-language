...
function layoutDefinition(nodeScope, scopedNodeIDs, columnizedNodes, definitions, connections) {
  ...
  var match = Belt_List.reduceWithIndex(columnizedNodes, /* tuple */[
        ...
        Belt_MapString.empty
          ...
          return Belt_List.reduce(Belt_List.keep(nodes, (function (node) {
                        ...
                        if (exit === 1) {
                          match$1 = /* tuple */[
                            /* record */Block.record([
                                ...
                                1,
                                Definition$ReactTemplate.countNodeNibs(node[/* node */1], definitions) + 1 | 0
                              ]),
                            Belt_MapString.empty
                          ];
                        }
                        ...
                        var adjustedChildren = Belt_MapString.map(match$1[1], (function (nodeLayout) {
                                ...
                                return /* record */Block.record([
                                          ...
                                          Block.record([
                                              ...
                                              init[/* columns */0],
                                              (nodeLayout[/* position */0][/* rows */1] + 2 | 0) + rows | 0
                                            ]),
                                          nodeLayout[/* size */1],
                                          nodeLayout[/* depth */2] + 1 | 0
                                        ]);
                              }));
                        ...
                        return /* tuple */[
                                newFilledness,
                                Helpers$ReactTemplate.simpleMergeMaps(Belt_MapString.set(param[1], node[/* id */0], /* record */Block.record([
                                            "position",
                                            "size",
                                            "depth"
                                          ], [
  ...
  return /* tuple */[
          ...
          /* record */Block.record([
              ...
              columnFilledness.length,
              Belt_Array.reduce(columnFilledness, 0, Caml_obj.caml_max) + 1 | 0
            ])
        ];
}
...
function layoutSubGraph(definitionNode, scopedNodeIDs, columnizedNodes, definitions, connections) {
  ...
  var match$1 = layoutDefinition(/* NodeScope */Block.simpleVariant("NodeScope", [definitionNode[/* id */0]]), scopedNodeIDs, columnizedNodes, definitions, connections);
  ...
  return /* tuple */[
          /* record */Block.record([
              ...
              Caml_primitive.caml_int_max(0, (position[/* columns */0] - 1 | 0) - firstColumn | 0) + 2 | 0,
              Caml_primitive.caml_int_max(nibRows, position[/* rows */1]) + 1 | 0
            ]),
          match$1[0]
        ];
}
...
function layoutGraph(scopedNodeIDs, columnizedNodes, definitions, connections) {
  ...
  return /* tuple */[
          Belt_MapString.map(match[0], (function (nodeLayout) {
                  ...
                  return /* record */Block.record([
                            ...
                            Block.record([
                                ...
                                init[/* columns */0],
                                nodeLayout[/* position */0][/* rows */1] + 2 | 0
                              ]),
                            nodeLayout[/* size */1],
                            nodeLayout[/* depth */2]
                          ]);
          ...
          /* record */Block.record([
              ...
              dimensions[/* columns */0] + 2 | 0,
              dimensions[/* rows */1] + 1 | 0
            ])
        ];
}
