...
function make(definitions, implementation, documentation, display, emit, _children) {
  return /* record */[
          ...
          /* render */(function (_self) {
              return React.createElement("div", undefined, React.createElement("h1", undefined, "Record"), React.createElement("h2", undefined, "Fields:"), ReasonReact.element(undefined, undefined, TypedFields$ReactTemplate.make(definitions, implementation, documentation[/* inputs */2], true, display[/* inputOrdering */0], emit, /* array */[])), React.createElement("a", {
