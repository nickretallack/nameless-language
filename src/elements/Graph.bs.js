          ...
          /* render */(function (self) {
              ...
              return React.createElement("div", undefined, React.createElement("input", {
                              ...
                              onTouchMove: (function ($$event) {
                                  ...
                                  className: "outputs"
                                }, SimpleNode$ReactTemplate.renderNibs(Definition$ReactTemplate.displayKeywordOutputs(definition, "en"), "output internal", false, /* GraphConnection */0, self[/* send */3], selectedGraphOutputNib)), React.createElement("div", {
                                  className: "inputs"
                                }, SimpleNode$ReactTemplate.renderNibs(Definition$ReactTemplate.displayKeywordInputs(definition, "en"), "input internal", true, /* GraphConnection */0, self[/* send */3], selectedGraphInputNib)), Helpers$ReactTemplate.renderStringMap((function (param) {
                                    var nodeID = param[0];
                                    var match = self[/* state */1][/* selectedNib */2];
                                    var tmp;
                                    if (match !== undefined) {
